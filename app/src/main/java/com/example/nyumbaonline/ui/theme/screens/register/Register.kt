...
fun Register(navController: NavController){
    ...
    var Company by remember { mutableStateOf(value = "") }
    var Nationality by remember { mutableStateOf(value = "") }
  //  var Id.No by remember { mutableStateOf(value = "") }
    var HomeCounty by remember { mutableStateOf(value = "") }
    ...
    Column(modifier = Modifier.fillMaxWidth().fillMaxHeight(), verticalArrangement = Arrangement.Center) {
        Text(text = "Register Here!",
            ...
            modifier = Modifier.background(Color.LightGray).fillMaxWidth().padding(20.dp)
        ...
        OutlinedTextField(value = Fullname, onValueChange = {newFullName -> Fullname = newFullName}, label = { Text(text = "Enter your Fullname") }, placeholder = { Text(text = "Please enter Fullname") }, modifier = Modifier.wrapContentWidth().align(
        ...
        OutlinedTextField(value = password, onValueChange = {newPassword->password=newPassword}, label = { Text(text = "Enter Password") }, placeholder = { Text(text = "Please input Password") }, modifier = Modifier.wrapContentWidth().align(
